...
class CreateFuncionariosTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Funcionarios", 'funcionarios', 'nome', 'fa-cube', [
            ...
            ["complemento", "Complemento", "Address", false, "", 0, 256, false],
            ["bairro", "Bairro", "String", false, "", 0, 256, false],
            ["cep", "CEP", "String", false, "", 0, 256, false],
            ["telefone1", "Telefone 1", "Mobile", false, "", 0, 20, false],
            ["telefone2", "Telefone 2", "Mobile", false, "", 0, 20, false],
            ["telefone3", "Telefone 3", "Mobile", false, "", 0, 20, false],
            ["valor_hora", "Valor Hora", "Decimal", false, "", 0, 11, false],
            ["centro_custo", "Centro Custo", "Decimal", false, "", 0, 11, false],
            ["cpf", "CPF", "String", false, "", 0, 256, false],
            ["ativo", "Ativo", "Dropdown", false, "", 0, 0, false, ["ATIVO","DESATIVADO"]],
            ["matricula", "Matricula", "String", false, "", 0, 256, false],
        ]);
