...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $manuntencao->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Manuntencaos", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/manuntencaos/'.$manuntencao->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Manuntencaos", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.manuntencaos.destroy', $manuntencao->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/manuntencaos') }}" data-toggle="tooltip" data-placement="right" title="Back to Manuntencaos"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'centro_custo')
						@la_display($module, 'tipo_equipamento')
						@la_display($module, 'modelo')
						@la_display($module, 'fabricante')
						@la_display($module, 'fornecedor')
						@la_display($module, 'Valor de Compra')
						@la_display($module, 'valor_venda')
						@la_display($module, 'data_compra')
						@la_display($module, 'data_venda')
